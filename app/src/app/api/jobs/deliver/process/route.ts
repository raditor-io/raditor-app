/**
 * Deliver queue worker: executes queued deliver_feed_item jobs (signed
 * webhook pushes) and nothing else — each queue gets its own domain route.
 * Vercel cron calls GET /api/jobs/deliver/process every minute with
